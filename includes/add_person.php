...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $check_query = "SELECT * FROM Person WHERE name='$name' AND surname='$surname' AND patronim='$patronim' AND age='$age' AND address='$address' AND telephone='$telephone'";
    ...
    if ($check_result->num_rows > 0) {
        ...
        $sql = "INSERT INTO Person (name, surname, patronim, age, address, telephone) 
                VALUES ('$name', '$surname', '$patronim', $age, '$address', '$telephone')";
